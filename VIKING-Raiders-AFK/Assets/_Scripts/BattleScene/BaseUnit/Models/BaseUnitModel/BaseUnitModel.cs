...
public abstract class BaseUnitModel : ScriptableObject
{
    ...
    public abstract int GetUnitDamage(int unitLevel);
    // public abstract int GetArmourPerUnitLevel(int unitLevel);
    // public abstract int GetHealthPerUnitLevel(int unitLevel);
